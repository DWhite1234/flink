...
public class AggregateAndProcessWindow {
    public static void main(String[] args) throws Exception {
        ...
        // 1.数据样例
        DataStreamSource<Tuple3<Integer, Integer, Long>> datastream = env.fromElements(new Tuple3<Integer, Integer, Long>(1, 1, 1000L), new Tuple3<Integer, Integer, Long>(1, 3, 3000L), new Tuple3<Integer, Integer, Long>(1, 2, 6000L));
